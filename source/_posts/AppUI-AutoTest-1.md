...
{% img https://i.loli.net/2021/05/24/BaDFwHCvbWk8g1x.png %}
...
{% img https://i.loli.net/2021/05/20/LWRPKYaSbQji4yH.png %}
然而我们的测试对象是App，怎么定位App里的元素呢？答案是利用Appium和模拟器。
打开我们下载的Appium desktop应用：
{% img https://i.loli.net/2021/05/20/Xb2R1rJf3PNDEkV.png %}
选择 Start Server, Appium Server就运行起来啦:
{% img https://i.loli.net/2021/05/20/r27GjW6cAdwHtSK.png %}
鼠标hover到右上角的🔍图标，出现tip提示 **Start Inspector Session**，很明显这就是我们用来定位App元素的工具啦，点击之后出现下图窗口：
{% img https://i.loli.net/2021/05/20/t3b2iRPjNBOpW8x.png %}
...
{% img https://i.loli.net/2021/05/20/eJZMpn3ayOgB78i.png %}
...
{% img https://i.loli.net/2021/05/20/VdDgGbmSFpCOUea.png %}
...
{% img https://i.loli.net/2021/05/20/MLUTP2BbmGR76Op.png %}
...
{% img https://i.loli.net/2021/05/26/SrQML96uvleWqBX.png %}
...
{% img https://i.loli.net/2021/05/26/nhUuXidOpwWzZ9G.png %}

## Android
### 启动Android Emulator
打开我们下载的Android Studio，进入编辑页面，点击右上角AVD Manager图标打开模拟器窗口：
{% img https://i.loli.net/2021/05/20/wiFyJgqWZXbDAmG.png %}
...
{% img https://i.loli.net/2021/05/24/n1865FmjlbKyupU.png %}
...
{% img https://i.loli.net/2021/05/24/TM3skJ47iDX8l9b.png %}
...
{% img https://i.loli.net/2021/05/24/MoekacB4D9TAtsu.png %}

事实上，你可以同时打开iOS和Android的模拟器和元素定位窗口，一起定位iOS和Android的元素：

{% img https://i.loli.net/2021/05/24/R6yJCZVgfUNwQB5.png %}
...
{% img https://i.loli.net/2021/05/26/dvgs5SKQrHXEkUh.png %}
